  ...
  return (
    <div>
      ...
      <div className="flex flex-col p-5 mt-5 border-color03 border-solid border shadow-lg rounded-lg">
        <div className="flex items-center gap-3 pb-5 border-b border-color03 border-solid">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-1">
              ...
              <p className="text-xs text-color02 underline">{trip.location}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col mt-5 text-color02">
          ...
          <h3 className="font-semibold text-color02 mt-3 pt-5 border-t border-solid border-color03">Informações sobre o preço</h3>

          <div className="flex justify-between mt-1">
            <p className="text-color02 text-sm mt-2">Total:</p>
